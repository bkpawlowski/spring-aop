package pl.grizzlysoftware.blog.modules.processor.module2;
 ...
 */
@Component
public class SurnameChangingProcessor implements EntityProcessor<EmployeeEntity> {
    public void process(EmployeeEntity e) {
        e.setSurname("Modified_"+e.getSurname());
    }
}
